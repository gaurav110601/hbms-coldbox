            ...
            <div class="row ">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Unread Enquiry</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="header-title">Unread Enquiry</h4>
                        ...
                        <div class="card-body">
                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    <cfif '#prc.unreadEnquiryData.recordcount#' != 0>
                                        <cfloop query="#prc.unreadEnquiryData#">
                                            <tr>
                                                <td>#prc.sn++#</td>
                                                <td>#name#</td>
                                                <td>#email#</td>
