            ...
            <div class="row ">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Search Bookings</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="header-title">Search Bookings</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="text-md-end dataTables_filter" id="dataTable_filter">
                                        <form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search" method="POST" action="#event.buildLink( "admin:search.searchBooking" )#">
                            ...
                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    <cfif '#prc.searchBookingData.recordcount#' != 0>
                                        <cfloop query="#prc.searchBookingData#">
                                            <tr>
                                                <td>#prc.sn++#</td>
                                                <td>#bookingNumber#</td>
                                                <td>#name#</td>
                                                ...
                                                <td>
                                                    ...
                                                    <!--- <button type="button" class="btn btn-primary" value="#id#" onclick="window.location='#event.buildLink( "admin:home.viewBooking", "id=#id#" )#'" id="bookingDetail"> View Details</button> --->
                                                </td>
                                            </tr>
                                        </cfloop>
                                        <cfelse>
