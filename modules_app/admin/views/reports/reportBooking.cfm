            ...
            <div class="row ">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Booking Between Dates Report</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="header-title">Booking Between Dates Report:</h4>
                        ...
                        <div class="card-body">
                            <form class="needs-validation" method="POST" action="#event.buildLink( "admin:reports.bookingReport" )#">
                                <div class="mb-3">
