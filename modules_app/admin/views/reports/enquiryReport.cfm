                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Report Enquiry</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Between Dates Enquiry Report</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="header-title text-primary">Report from #rc.fromDate# to #rc.toDate#</h4>
                        ...
                        <div class="card-body">
                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    <cfif '#prc.enquiryReportData.recordcount#' != 0>
                                        <cfloop query="#prc.enquiryReportData#">
                                            <tr>
                                                <td>#prc.sn++#</td>
                                                <td>#name#</td>
                                                <td>#email#</td>
                                                ...
                                                <td>
                                                    <a class="btn btn-primary" href="#event.buildLink( "admin:reports.viewEnquiryReport", "id=#id#" )#">View Details</a>
                                                </td>
                                            </tr>
                                        </cfloop>
                                        <cfelse>
