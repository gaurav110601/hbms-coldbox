                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    <cfif '#prc.categoryData.recordcount#' != 0>
                                        <cfloop query="#prc.categoryData#">
                                            <tr>
                                                ...
                                                <td>#price#</td>
                                                <td>
                                                    <a class="btn btn-primary" href="#event.buildLink( "admin:category.editCategory", "id=#id#" )#">
                                                        <i class="bi bi-pencil"></i>
                                                    </a>
                                                    <a class="btn btn-danger" onclick="return confirm('are you sure?')" href="#event.buildLink( "admin:category.deleteCategory", "id=#id#" )#">
