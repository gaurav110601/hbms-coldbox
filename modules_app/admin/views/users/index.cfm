                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <!--- <li class="breadcrumb-item"><a>Registered Users</a></li> --->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    <cfif '#prc.usersData.recordcount#' != 0>
                                        <cfloop query="#prc.usersData#">
                                            <tr>
                                                <td>#prc.sn++#</td>
                                                <td>#name#</td>
                                                <td>#email#</td>
                                                <td>#mobileNumber#</td>
                                                <td>
                                                    <a class="btn btn-primary" href="#event.buildLink( "admin:users.userBookings", "id=#id#" )#">View Bookings</a>
                                                </td>
                                            </tr>
                                        </cfloop>
                                        <cfelse>
